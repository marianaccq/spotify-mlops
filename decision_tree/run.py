...
def process_args(args):
    ...
    x_train, x_val, y_train, y_val = train_test_split(df_train.drop(['genre'], axis = 1),
                                                    df_train['genre'],
                                                    test_size=0.3,
                                                    random_state=41,
                                                    shuffle=True,
    ...
    logger.info("Classes [0, 1, 2, 3, 4]: {}".format(le.inverse_transform([0, 1, 2, 3, 4])))
    ...
    ConfusionMatrixDisplay(confusion_matrix(predict,
                                            y_val,
                                            labels=[0, 1, 2, 3, 4]),
                           display_labels=['Rap', 'Pop', 'Hiphop', 'trance', 'trap']
    ...
    plot_tree(pipe["classifier"], 
              filled=True, 
              rounded=True, 
              class_names=['Rap', 'Pop', 'Hiphop', 'trance', 'trap'],
