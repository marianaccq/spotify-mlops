...
if __name__ == "__main__":
    ...
    # mlflow run . -P input_artifact="spotify-mlops-preprocess/data_preprocessed:latest" -P artifact_root="data" -P artifact_type="trainvaltest_data" -P test_size=0.3 -P random_state="13" -P stratify="genre"