...
def process_args(config: DictConfig):
    ...
    if "download" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "artifact_name": "spotify_mlops.csv",
                "artifact_type": "raw_data",
                "artifact_description": "This is a Dataset of songs in Spotify"
            }
        )
    ...
    if "preprocess" in steps_to_execute:
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "input_artifact": "spotify_mlops.csv:latest",
                "artifact_name": "data_preprocessed.csv",
                "artifact_type": "preprocess_data",
                "artifact_description": "This is a Dataset of songs in Spotify preprocessed"
            }
        )
    ...
    if "segregate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "input_artifact": "data_preprocessed.csv:latest",
                "artifact_root": "data",
